...
//  The kernel takes two arguments: a (input),
//  and b (input)
//
bool CreateMemObjects(cl_context context, cl_mem memObjects[2],
                      cl_int *a, cl_int *b)
{
    memObjects[0] = clCreateBuffer(context, CL_MEM_COPY_HOST_PTR,
                                   sizeof(cl_int) * ARRAY_SIZE, a, NULL);
    memObjects[1] = clCreateBuffer(context, CL_MEM_COPY_HOST_PTR,
                                   sizeof(cl_int) * ARRAY_SIZE, b, NULL);
